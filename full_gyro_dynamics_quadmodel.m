...
KEapprox = subs(taylor(KEsmallangle, epsilon, 'Order', 4), epsilon, 1)
...
EoM = dbydtofdelLdelqdot - delLdelq == 0;
...
Soln = solve(EoM, thyddot, thzddot);

thetaydoubledot = simplify(Soln.thyddot)
thetazdoubledot = simplify(Soln.thzddot)

jacobian([thetaydoubledot, thetazdoubledot], [thxT, thyT, thzT, thxTdot, thyTdot, thzTdot, thxTddot, thyTddot, thzTddot])