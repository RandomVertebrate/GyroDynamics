...
plot(t, (180/pi)*xExcitation, t, (180/pi)*yExcitation, t, ...
    (180/pi)*zExcitation, t, (180/pi)*error(:,1), t, (180/pi)*error(:,2))
xlabel('Time (sec)');
ylabel('Angle (deg)');
legend('Tank Roll', 'Tank Pitch', 'Tank Yaw', 'L.o.S. Pitch', 'L.o.S. Yaw');
